...
class HomeTabbarEducationVideo extends StatefulWidget {
  const HomeTabbarEducationVideo(
      {Key? key,
      //required this.width,
  ...
  @override
  State<HomeTabbarEducationVideo> createState() => _CustomVideoPlayerState();
}

class _CustomVideoPlayerState extends State<HomeTabbarEducationVideo> {
